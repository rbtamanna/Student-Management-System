    ...
    <div class="d-flex align-items-center">
        ...
        <div class="dropdown d-inline-block ml-2">
            <button type="button" class="btn btn-sm btn-dual d-flex align-items-center" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <span class="d-none d-sm-inline-block ml-2">{{session('user_data')['last_name'] }}</span>
            ...
            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right p-0 border-0" aria-labelledby="page-header-user-dropdown">
                <div class="p-3 text-center bg-primary-dark rounded-top">
                    ...
                    <p class="mt-2 mb-0 text-white font-w500"> {{ session('user_data')['first_name'].' '.session('user_data')['last_name']  }}</p>
                    @if(session('user_data')['user_type']==\Illuminate\Support\Facades\Config::get('variable_constants.user_type.admin'))
                        <p class="mb-0 text-white-50 font-size-sm">Admin</p>
                    @else
                        <p class="mb-0 text-white-50 font-size-sm">Student</p>
                    @endif
                </div>
                <div class="p-2">
