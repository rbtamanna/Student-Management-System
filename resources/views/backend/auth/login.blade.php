            ...
            <div class="row no-gutters bg-primary-dark-op">
                ...
                <div class="hero-static col-lg-4 d-none d-lg-flex flex-column justify-content-center">
                    <div class="p-4 p-xl-5 flex-grow-1 d-flex align-items-center">
                        <div class="w-100">
                            <a class="link-fx font-w600 font-size-h2 text-white" >
                                <span class="font-w400">SMS</span>
                            </a>
                    ...
                    <div class="p-4 p-xl-5 d-xl-flex justify-content-between align-items-center font-size-sm">
                        <p class="font-w500 text-white-50 mb-0">
                            <strong>SMS</strong> &copy; <span data-toggle="year-copy"></span>
                        </p>
                    ...
                    <div class="p-4 w-100 flex-grow-1 d-flex align-items-center">
                        <div class="w-100">
                            ...
                            <div class="text-center mb-5">
                                <p class="mb-3">
                                    <img src="{{ asset('backend/media/photos/logo.jpg') }}" alt="Logo" style="height: 120px; margin-left: 5%">
                                </p>
                                ...
                                <div class="col-sm-8 col-xl-4">
                                    <form class="js-validation-signin" action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="form-group d-flex justify-content-between align-items-center">
                                            <div>
                                                <a class="text-muted font-size-sm font-w500 d-block d-lg-inline-block mb-1" href="{{url('forget_password')}}">
                                                    Forgot Password?
                                                </a>
                                            </div>
                                            <div>
