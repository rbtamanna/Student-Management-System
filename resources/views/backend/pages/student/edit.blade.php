...
@section('content')
    <div class="content">
        ...
        <div class="block block-rounded">
            ...
            <form class="js-validation" action="{{ url('student/'.$student->id.'/update') }}" id="form" method="POST" >
                @csrf
                <div class="block block-rounded">
                        ...
                        <div class="row items-push ml-10">
                            <div class="col-lg-6 col-xl-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email"  class="form-control input-prevent-multiple-submission" id="email" name="email" value="{{ $student->email }}" placeholder="Enter email.." required>
                                </div>
                                <div class="form-group ">
